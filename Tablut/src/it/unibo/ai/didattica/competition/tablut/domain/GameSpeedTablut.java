 ...
 *
 */
public class GameSpeedTablut implements Game {
	...
	public GameSpeedTablut(int repeated_moves_allowed, int cache_size, String whiteName,
						   String blackName) {
		this(new StateTablut(), repeated_moves_allowed, cache_size, whiteName, blackName);
	}

	public GameSpeedTablut(State state, int repeated_moves_allowed, int cache_size,
